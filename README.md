# SEDS-INDUCTION
AGNI GUPTA 
i joined the group very late got only 3-4 days and im leaving for my home tmrw so i could only do task 1 for avionics
task1
idea was to create a real time graph using real time csv files
first had to clean the data points for noise and other crap for which then i created a new updated cleaned csv file
